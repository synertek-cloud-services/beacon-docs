...
Linux Remote Shell is supported in the current beta. Windows Remote Shell is unvalidated. macOS is unvalidated. A connection that remains at **Connecting…** beyond a check-in interval should be investigated with the agent log and browser console/network details.

Beacon does not provide RustDesk remote desktop or RDP tunneling in this beta. Those older docs have been retained only as beta-boundary notes to prevent a broken historical link; use Remote Shell instead.
